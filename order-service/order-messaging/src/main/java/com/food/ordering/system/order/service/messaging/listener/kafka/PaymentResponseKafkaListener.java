...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
    ...
    public void receive(@Payload List<PaymentResponseAvroModel> messages,
        ...
        log.info("{} number of payment response received with keys: {}, partitions: {} and offset: {}",
        ...
        messages.forEach(paymentResponseAvroModel -> {
            if (PaymentStatus.COMPLETED.equals(paymentResponseAvroModel.getPaymentStatus())) {
                ...
                log.info("Processing unsucessful payment for order id: {}", paymentResponseAvroModel.getOrderId());
