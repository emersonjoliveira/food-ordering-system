...
public class OrderMessagingDataMapper {
    ...
    public PaymentRequestAvroModel orderCancelledEventToPaymentRequestAvroModel(OrderCancelledEvent orderCancelledEvent) {
        final var order = orderCancelledEvent.getOrder();
        return PaymentRequestAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
                .setCustomerId(order.getCustomerId().getValue().toString())
    ...
    public RestaurantApprovalRequestAvroModel orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        final var order = orderPaidEvent.getOrder();
    ...
    public RestaurantApprovalResponse approvalResponseAvroModelToApprovalResponse(
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .failureMessages(restaurantApprovalResponseAvroModel.getFailuredMessages())
                .build();
    }
}
