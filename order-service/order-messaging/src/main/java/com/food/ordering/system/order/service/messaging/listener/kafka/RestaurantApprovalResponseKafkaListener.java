...
public class RestaurantApprovalResponseKafkaListener implements KafkaConsumer<RestaurantApprovalResponseAvroModel> {
    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        log.info("{} number of restaurant approval responses received with keys {}, patitions {} and offsets {}",
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            if (OrderApprovalStatus.APPROVED.equals(restaurantApprovalResponseAvroModel.getOrderApprovalStatus())) {
                ...
                log.info("Processing rejected order for order id: {}, with failure messages: {}",
                        ...
                        String.join(FAILURE_MESSAGE_DELIMITER, restaurantApprovalResponseAvroModel.getFailuredMessages()));
