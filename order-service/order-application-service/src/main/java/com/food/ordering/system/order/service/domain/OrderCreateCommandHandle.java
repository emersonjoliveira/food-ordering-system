...
public class OrderCreateCommandHandle {
    ...
    public OrderCreateCommandHandle(OrderDomainService orderDomainService, OrderRepository orderRepository,
    ...
    private Order saveOrder(Order order) {
        ...
        try {
            orderPersisted = orderRepository.save(order);
        } catch (Exception e) {
            log.error("Could not save order !");
            throw new OrderDomainException("Could not save order !");
        }
        log.info("Order is saved with id: {}", orderPersisted.getId().getValue());
